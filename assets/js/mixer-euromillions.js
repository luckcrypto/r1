function startEuroDrum(canvasId) {
    ...
    function getBallColor(isLuckyStar, number) {
        return isLuckyStar ? '#FFFF00' : '#FF2323';
    }

    class Ball {
        constructor(x, y, velX, velY, size, number, isLuckyStar = false) {
            this.x = x;
            this.y = y;
            this.velX = velX;
            this.velY = velY;
            this.size = size;
            this.number = number;
            this.isLuckyStar = isLuckyStar;
            this.baseColor = getBallColor(isLuckyStar, number);
        }
        ...
        draw() {
            ...
            ctx.fillStyle = this.isLuckyStar ? '#000000' : '#ffffff';
