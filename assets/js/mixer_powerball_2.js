...
function startLotteryDrum(canvasId) {
    ...
    class Ball {
        constructor(x, y, velX, velY, size, number) {
            this.x = x;
            this.y = y;
            this.velX = velX;
            this.velY = velY;
    ...
    // Create 26 balls – starting clustered near bottom
    const balls = [];
